...
export async function VaultCreate(label, username, encrypted_password, salt, nonce, notes='', accessToken){
    const abortController = new AbortController();
    setTimeout(() => abortController.abort())
...
export async function VaultEdit(label, username, encrypted_password, salt, nonce, notes='', accessToken){
    const abortController = new AbortController();
    setTimeout(() => abortController.abort())
...
export async function VaultDelete(label, username, encrypted_password, accessToken){
    const abortController = new AbortController();
    setTimeout(() => abortController.abort())
